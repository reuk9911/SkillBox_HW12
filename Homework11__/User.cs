...
{
    public abstract class User : IEnumerable, IClientMonitor, IClientEdit
    {
        /// <summary>
        /// Ссылка на БД
        /// </summary>
        ...
        ///// <summary>
        ///// Коллекция имен полей и доступа к ним
        ///// </summary>
        //public ReadOnlyCollection<FieldNameAccess> FNameAccess { get; protected set; }
